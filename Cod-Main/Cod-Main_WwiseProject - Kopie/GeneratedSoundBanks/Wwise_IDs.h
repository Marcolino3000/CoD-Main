...
namespace AK
{
    namespace EVENTS
    {
        ...
        static const AkUniqueID DOOR_HOUSE_OUTSIDE_OPEN = 509453139U;
        static const AkUniqueID DOOR_SLAM = 3678466239U;
        static const AkUniqueID DOUGH_REACT_GROW_START = 1205543049U;
        static const AkUniqueID DOUGH_REACT_GROW_STOP = 597432099U;
        static const AkUniqueID DOUGH_REACT_SHRINK_START = 2755388175U;
