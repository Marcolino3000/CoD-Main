Shader "Sprites/Custom/LineBoil URP Fix"
                                        {
                                            Properties
                                            {
                                                ...
                                                _NoiseSnap ("Noise Snap", Range(0.01, 1)) = 0.1
                                            }
                                            ...
                                            SubShader
                                            {
                                                ...
                                                Pass
                                                {
                                                    ...
                                                    Varyings vert(Attributes IN)
                                                    {
                                                        ...
                                                        float2 seed = OUT.positionHCS.xy + float2(time, 0.0);
                                                        float2 noise = float2(rand(seed), rand(seed + float2(1.0, 1.0))) * _NoiseScale;
